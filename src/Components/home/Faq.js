    ...
    return (
        <div className="block faqBlock">
            <div className="container-fluid">
                ...
                >
                    <Panel header="How to setup the theme?" key="1" className="site-collapse-custom-panel">
                    ...
                    <Panel header="Can I change plan or cancel at any time?" key="2" className="site-collapse-custom-panel">
                    ...
                    <Panel header="Can I manage multiple task?" key="3" className="site-collapse-custom-panel">
                    ...
                    <Panel header="How to manage my account?" key="4" className="site-collapse-custom-panel">
